...
export default function VerificationCenter() {
  ...
  const setPage = (data) => {
    const newData = data.filter((object) => object.active === "pending");
    ...
    <>
      <div className="flex-col w-full">
        ...
        <div className="h-[calc(100vh-95px)] overflow-y-auto">
            ...
            <table className="font-dm w-full text-sm text-left text-white bg-gradient-to-r from-[#2F2F2F]/100 to-[#3A3A3A]/0">
              <thead className="font-dm text-base font-normal text-white/0.81 border-[#7E7E7E] border-b">
                ...
                >
                  ...
                  <th scrope="col" className="py-3 pl-2"></th>
                </tr>
              </thead>
              <tbody>
                {staticdata.filter((object) => object.active === "pending")
                  .length > 0 ||
                staticdataCopy.filter((object) => object.active === "pending")
                  .length > 0 ? (
          ...
          {staticdataCopy.filter((object) => object.active === "pending")
            .length > 0 ||
          staticdata.filter((object) => object.active === "pending").length >
            0 ? (
            <>
         
              <div className="flex items-center justify-end font-lexend m-8">
