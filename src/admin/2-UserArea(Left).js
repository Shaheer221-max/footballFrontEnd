...
export default function UserAreaLeft() {
  ...
  const getPlayersLeft = async () => {
    await axios
      .get("https://football-backend-updated.herokuapp.com/users/GetLeftPlayers")
      .then((res) => {
        console.log(res?.data?.data);
          ...
          <div className="w-72 mr-8">
            <div className="flex rounded-lg text-lg text-left text-white  bg-zinc-800 p-18">
              ...
              <div className="flex-1 mt-3 mt-8 ml-4">
                <h1 className="text-3xl font-bold">{totalPlayers - playersLeft}</h1>
