    ...
    <>
      <div>
        {opensubcat === false ? (
          <div
            ...
            className={"p-3 max-w-sm max-h-[180px] rounded-lg bg-white"}
          >
            ...
            className="p-3 max-w-sm max-h-[180px] rounded-lg bg-green-500"
          >
                <div className="flex items-center ">
      ...
      >
        <div className="relative p-4 w-full max-w-lg  ">
          <div className="relative bg-gradient-to-r from-[#0000003D] to-[#6A6A6A00]  rounded-lg px-4 py-2">
            <button
            ...
            <div className="flex items-center justify-center my-2">
              <button className="inline-flex items-center py-2 px-4  text-sm font-medium text-white bg-green-500 rounded-[4px] ">
                ADD
              </button>
            </div>
          </div>
