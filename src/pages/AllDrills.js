              ...
              <table className="w-full text-left  text-gray-400 ">
                <thead className="text-sm  2xl:text-lg font-dm text-white/43   border-b border-grey-400">
                  <tr className="text-center font-dm">
                    ...
                    <th scope="col" className="py-3 px-7 xl:px-10 2xl:px-12"></th>
                  </tr>
                </thead>
                <tbody>
                  {drills.map((val, ind) => (
                    <tr className=" border-b text-white/1 text-sm   2xl:text-base font-lexend border-gray-400 text-center">
                      ...
                      <td className="py-4 px-7 xl:px-10 2xl:px-12">Passing</td>
                      <td className="py-4 px-7 xl:px-10 2xl:px-4">20-Aug-22</td>
                      <td className="py-4 px-7 xl:px-10 2xl:px-12">2.00</td>
                      <td className="py-4 px-7 xl:px-10 2xl:px-12">mp4</td>
