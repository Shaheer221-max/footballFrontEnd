  ...
  return (
        ...
        <div className="w-full ">
          ...
          <div className="grid grid-cols-2 gap-4 pr-8 lg:mt-[36px] ">
            {getEvents.map((val, ind) => (
              <div
                key={ind}
                className="schedule flex   py-1 pr-[16px] w-full h-full  rounded-xl   shadow-md bg-gray-800 "
              >
                ...
                <div>
                  ...
                  <div className="flex items-center mb-4 gap-4 mt-2">
                    ...
                    <p className="text-[15px] leading-5   font-light   text-gray-400">
                      {val.date.split("T")[0]}
                    </p>
                    <svg
                      className="ml-auto"
    ...
    <div
     ...
     <div
        ...
        className={!openAddsubcatmodal?"hidden":" flex absolute top-[60px] right-[200px]  z-50 w-52 h-24   bg-white rounded-xl justify-center content-center items-center"}
      >
         <div className="w-full">
                      ...
                      <h5 className="text-[#212121] text-center mt-4 mb-4 text-sm font-normal font-lexend cursor-pointer  " onClick={() => setopenAddsubcatmodal(false)} >
      ...
      <div
        ...
        className={!opendeletemodal?"hidden":" flex absolute top-0 right-0 left-0  w-full h-screen   bg-black/90 justify-center items-center"}
      >
